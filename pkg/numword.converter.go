...
// func getLocaleFormatter(language string) locale.LocaleFormatter {
// 	switch language {
// 	case "ja":
...
// 	// Apply decimal chopping to avoid floating point precision issues
// 	amount = formatter.ChopDecimal(amount, 2)
...
// func (op *NumI18NOptions) getFractionalWords(fractionalPart float64, targetLocale locale.NumI18NLocale, formatter locale.LocaleFormatter) (int64, string) {
...
// // DemoFormatterInterface demonstrates how formatters work hand-in-hand with the LocaleFormatter interface
// // Similar to how Circle and Rectangle implement the Shape interface
// func DemoFormatterInterface() {
// 	// Create formatter instances
// 	englishFormatter := &formatter.EnglishFormatter{}
// 	japaneseFormatter := &formatter.JapaneseFormatter{}
// 	filipinoFormatter := &formatter.FilipinoFormatter{}

// 	// Get some sample locales
// 	locales := Locale.FindByLocale("en-US")
// 	if len(locales) == 0 {
// 		return
// 	}
// 	usLocale := locales[0]
...
// 	var f locale.LocaleFormatter

// 	// Assign English formatter to the interface variable
// 	f = englishFormatter
// 	fmt.Printf("English: %s\n", f.FormatNumber(123, usLocale))

// 	// Assign Japanese formatter to the interface variable
// 	f = japaneseFormatter
// 	fmt.Printf("Japanese: %s\n", f.FormatNumber(123, usLocale))

// 	// Assign Filipino formatter to the interface variable
// 	f = filipinoFormatter
// 	fmt.Printf("Filipino: %s\n", f.FormatNumber(123, usLocale))
// }

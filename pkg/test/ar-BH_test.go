...
func TestToWords_ArabicBH_Numbers(t *testing.T) {
	tests := []struct {
		name     string
		amount   float64
...
func TestToWords_ArabicBH_Currency(t *testing.T) {
	tests := []struct {
		name     string
		amount   float64
		options  *pkg.NumI18NOptions
...
func TestToWords_ArabicBH_Decimals(t *testing.T) {
	tests := []struct {
		name     string
		amount   float64
		options  *pkg.NumI18NOptions
...
func TestToWords_ArabicBH_Negative(t *testing.T) {
	tests := []struct {
		name     string
		amount   float64
		options  *pkg.NumI18NOptions
...
func TestToWords_ArabicBH_Formatting(t *testing.T) {
	tests := []struct {
		name     string
		amount   float64
		options  *pkg.NumI18NOptions
...
func TestToWords_ArabicBH_CustomCurrency(t *testing.T) {
	tests := []struct {
		name     string
		amount   float64
		options  *pkg.NumI18NOptions
...
func TestToWords_ArabicBH_EdgeCases(t *testing.T) {
	tests := []struct {
		name     string
		amount   float64
		options  *pkg.NumI18NOptions

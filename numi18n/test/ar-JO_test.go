...
func TestToWords_ArabicJO_Numbers(t *testing.T) {
	tests := []struct {
		name     string
		amount   float64
...
func TestToWords_ArabicJO_Currency(t *testing.T) {
	tests := []struct {
		name     string
		amount   float64
		options  *numi18n.NumI18NOptions
...
func TestToWords_ArabicJO_Decimals(t *testing.T) {
	tests := []struct {
		name     string
		amount   float64
		options  *numi18n.NumI18NOptions
...
func TestToWords_ArabicJO_Negative(t *testing.T) {
	tests := []struct {
		name     string
		amount   float64
		options  *numi18n.NumI18NOptions
...
func TestToWords_ArabicJO_Formatting(t *testing.T) {
	tests := []struct {
		name     string
		amount   float64
		options  *numi18n.NumI18NOptions
...
func TestToWords_ArabicJO_CustomCurrency(t *testing.T) {
	tests := []struct {
		name     string
		amount   float64
		options  *numi18n.NumI18NOptions
...
func TestToWords_ArabicJO_EdgeCases(t *testing.T) {
	tests := []struct {
		name     string
		amount   float64
		options  *numi18n.NumI18NOptions

...
var RURULocale = NumI18NLocale{
	...
	LocaleFormatter: &RussianRussiaFormatter{},
}

// RussianRussiaFormatter handles Russian (Russia) formatting
type RussianRussiaFormatter struct{}

func (f *RussianRussiaFormatter) FormatNumber(number int64, targetLocale NumI18NLocale) string {
	return ConvertToWordsWithExactMappingInt64(number, targetLocale)
}

func (f *RussianRussiaFormatter) FormatCurrency(result string, wholePart int64, currencyName, currencyPlural string) string {
	if wholePart == 1 {
...
func (f *RussianRussiaFormatter) FormatFractional(result, fractionalWords string, andText string) string {
...
func (f *RussianRussiaFormatter) ChopDecimal(value decimal.Decimal, precision int) decimal.Decimal {

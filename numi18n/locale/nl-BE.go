...
func (f *DutchBelgianFormatter) handleSingleDigits(number int64, targetLocale NumI18NLocale) string {
...
func (f *DutchBelgianFormatter) handleTens(number int64, targetLocale NumI18NLocale) string {
	tens := (number / 10) * 10
	ones := number % 10
...
func (f *DutchBelgianFormatter) handleHundreds(number int64, targetLocale NumI18NLocale) string {
	hundreds := number / 100
...
func (f *DutchBelgianFormatter) handleThousands(number int64, targetLocale NumI18NLocale) string {
...
func (f *DutchBelgianFormatter) findNumberWord(number int64, targetLocale NumI18NLocale) string {
	for _, mapping := range targetLocale.NumberWordsMapping {
		if mapping.Number == number {
			return strings.ToLower(mapping.Value)
		}

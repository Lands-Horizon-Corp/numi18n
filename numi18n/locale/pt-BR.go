...
var PTBRLocale = NumI18NLocale{
	...
	NumberWordsMapping: []NumberWordMapping{
		...
		{Number: 19000, Value: "dezenove mil"},
		{Number: 18000, Value: "dezoito mil"},
		{Number: 17000, Value: "dezessete mil"},
		{Number: 16000, Value: "dezesseis mil"},
	...
	LocaleFormatter: &PortugueseBrazilFormatter{},
}

// PortugueseBrazilFormatter handles Portuguese (Brazil) formatting
type PortugueseBrazilFormatter struct{}

func (f *PortugueseBrazilFormatter) FormatNumber(number int64, targetLocale NumI18NLocale) string {
	return ConvertToWordsWithExactMappingInt64(number, targetLocale)
}

func (f *PortugueseBrazilFormatter) FormatCurrency(result string, wholePart int64, currencyName, currencyPlural string) string {
	if wholePart == 1 {
...
func (f *PortugueseBrazilFormatter) FormatFractional(result, fractionalWords string, andText string) string {
	return result + " " + andText + " " + fractionalWords
}

func (f *PortugueseBrazilFormatter) FormatFractionalCurrency(result string, fractionalValue int64, fractionName, fractionPlural string) string {
...
func (f *PortugueseBrazilFormatter) FormatNegative(result, negativeWord string) string {
	return negativeWord + " " + result
}

func (f *PortugueseBrazilFormatter) ChopDecimal(value decimal.Decimal, precision int) decimal.Decimal {
